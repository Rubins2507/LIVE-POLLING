...
![LivePoll Preview](public/preview-banner.png)
...
├── server.ts                 # Integrated full-stack runner with WebSockets
├── docker-compose.yml        # Multi-container orchestration (App, Go, Mongo, Redis)
